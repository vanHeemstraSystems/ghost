...
function denestTransform(node, createNode) {
    ...
    const hasInvalidChild = children.some((child) => {
        if ((0, list_1.$isListNode)(child) && !isValidListNode(child)) {
            return true;
        }
        return child.isInline && !child.isInline() && !(0, list_1.$isListNode)(child) && !(0, list_1.$isListItemNode)(child);
    });
    if (!hasInvalidChild) {
        return;
    }
    ...
    children.forEach((child) => {
        if (((0, list_1.$isListNode)(child) && !isValidListNode(child)) || !(0, list_1.$isListNode)(child) && !(0, list_1.$isListItemNode)(child) && child.isInline && !child.isInline()) {
