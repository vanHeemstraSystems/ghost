...
exports.registerMergeListNodesTransform = exports.mergeListNodesTransform = void 0;
const list_1 = require("@lexical/list");
function mergeListNodesTransform(node) {
    const nextSibling = node.getNextSibling();
    if ((0, list_1.$isListNode)(nextSibling) && nextSibling.getListType() === node.getListType()) {
